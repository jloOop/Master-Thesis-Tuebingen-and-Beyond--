...
For pure scientific-computing / HPC applications, use this repository only as secondary evidence for physics-based analysis; the numerical quantum-dynamics repositories are stronger primary evidence.
