...
device geometry, pre-fabrication concepts, Josephson-ratchet measurement results,
I–V characterization, critical-current asymmetry, AC/noise rectification context,
and cryogenic measurement infrastructure.
...
Christoph Schmid*, Alireza Jozani*, Reinhold Kleiner, Dieter Koelle, Edward
